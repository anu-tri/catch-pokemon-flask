...
class User(UserMixin, db.Model):
    ...
    pokemon = db.relationship('Pokemon', backref='pokeauthor', lazy='dynamic')
    ...
    #get count of pokemons
    def count_of_pokemon(self):
        count_of_pokemons = Pokemon.query.filter_by(user_id=self.id).count()
        return count_of_pokemons
